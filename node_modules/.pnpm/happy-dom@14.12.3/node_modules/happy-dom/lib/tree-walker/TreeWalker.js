...
export default class TreeWalker {
     ...
     */
    firstChild() {
        const childNodes = this.currentNode ? this.currentNode[PropertySymbol.childNodes] : [];
    ...
    previousSibling() {
        if (this.currentNode !== this.root &&
            this.currentNode &&
            this.currentNode[PropertySymbol.parentNode]) {
            const siblings = this.currentNode[PropertySymbol.parentNode][PropertySymbol.childNodes];
