...
class Range {
    ...
    constructor(window) {
        ...
        __classPrivateFieldSet(this, _Range_window, window, "f");
    ...
    cloneContents() {
        ...
        for (const node of commonAncestor[PropertySymbol.childNodes]) {
        ...
        if (firstPartialContainedChild !== null &&
            ...
            fragment.appendChild(clone);
            const subRange = new (__classPrivateFieldGet(this, _Range_window, "f").Range)();
     ...
     */
    cloneRange() {
        const clone = new (__classPrivateFieldGet(this, _Range_window, "f").Range)();
    ...
    createContextualFragment(tagString) {
        ...
        return XMLParser.parse(this[PropertySymbol.ownerDocument], tagString);
    }
    /**
    ...
    deleteContents() {
        ...
        if (NodeUtility.isInclusiveAncestor(this[PropertySymbol.start].node, this[PropertySymbol.end].node)) {
            ...
            newOffset =
                referenceNode[PropertySymbol.parentNode][PropertySymbol.childNodes].indexOf(referenceNode) + 1;
        }
    ...
    insertNode(newNode) {
        ...
        let referenceNode = this[PropertySymbol.start].node[PropertySymbol.nodeType] === NodeTypeEnum.textNode
            ...
            : this[PropertySymbol.start].node[PropertySymbol.childNodes][this.startOffset] ||
                null;
        ...
        let newOffset = !referenceNode
            ...
            : referenceNode[PropertySymbol.parentNode][PropertySymbol.childNodes].indexOf(referenceNode);
        newOffset +=
    ...
    intersectsNode(node) {
        ...
        const offset = parent[PropertySymbol.childNodes].indexOf(node);
    ...
    setEndAfter(node) {
        ...
        this.setEnd(node[PropertySymbol.parentNode], node[PropertySymbol.parentNode][PropertySymbol.childNodes].indexOf(node) + 1);
    }
    /**
     * Sets the end position of a Range relative to another Node.
     *
    ...
    setEndBefore(node) {
        ...
        this.setEnd(node[PropertySymbol.parentNode], node[PropertySymbol.parentNode][PropertySymbol.childNodes].indexOf(node));
    }
    /**
    ...
    setStartAfter(node) {
        ...
        this.setStart(node[PropertySymbol.parentNode], node[PropertySymbol.parentNode][PropertySymbol.childNodes].indexOf(node) + 1);
    }
    /**
    ...
    setStartBefore(node) {
        ...
        this.setStart(node[PropertySymbol.parentNode], node[PropertySymbol.parentNode][PropertySymbol.childNodes].indexOf(node));
    }
    /**
...
_Range_window = new WeakMap(), _a = PropertySymbol.start, _b = PropertySymbol.end, PropertySymbol.ownerDocument;
