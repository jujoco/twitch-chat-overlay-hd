...
const DatasetFactory_js_1 = __importDefault(require("../element/DatasetFactory.cjs"));
/**
 * HTML Element.
 *
 * Reference:
...
class HTMLElement extends Element_js_1.default {
     ...
     */
    get dataset() {
        return (__classPrivateFieldSet(this, _HTMLElement_dataset, __classPrivateFieldGet(this, _HTMLElement_dataset, "f") ?? DatasetFactory_js_1.default.createDataset(this), "f"));
    }
    /**
     * Returns direction.
     *
