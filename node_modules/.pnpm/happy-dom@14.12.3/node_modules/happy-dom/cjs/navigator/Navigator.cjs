...
class Navigator {
     ...
     */
    get maxTouchPoints() {
        return (WindowBrowserSettingsReader_js_1.default.getSettings(__classPrivateFieldGet(this, _Navigator_ownerWindow, "f"))?.navigator.maxTouchPoints || 0);
    }
    /**
     ...
     */
    get userAgent() {
        return WindowBrowserSettingsReader_js_1.default.getSettings(__classPrivateFieldGet(this, _Navigator_ownerWindow, "f"))?.navigator.userAgent || '';
    }
    /**
